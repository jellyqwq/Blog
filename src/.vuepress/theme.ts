...
export default hopeTheme({
  ...
  blog: {
    ...
    medias: {
      BiliBili: "https://space.bilibili.com/496306493",
      GitHub: "https://github.com/jellyqwq",
      Rss: "/rss.xml",
  ...
  // sidebar, 注释掉可以使用默认生成的
  // sidebar: zhSidebar,

  footer: "我可是有底线的( •̀ ω •́ )✧",

  displayFooter: true,

  copyright: "MIT Licensed | Copyright © 2020-Present Jelly",
  ...
  plugins: {
    ...
    comment: {
      provider: "Giscus",
      repo: "jellyqwq/Giscus-comments",
      repoId: "R_kgDOIJ-2TA",
      category: "General",
      categoryId: "DIC_kwDOIJ-2TM4CR2ce",
    },
