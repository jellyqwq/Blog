...
高风险地区：98
中风险地区：0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16);function _(f,x){const d=c("ExternalLinkIcon");return s(),t("div",null,[v,r(" more "),u,i("p",null,[e("一开始使用卫健委官网的数据，写正则表达式来匹配，但后来发现出现了412错误，似乎，爬虫在无cookie的情况下访问该网站会先返回412错误同时设置3个cookie，然后返回错误的同时也返回了一个带有"),m,e("标签的DOM文档，这个script标签会请求的JavaScript文件来生成并设置一个cookie，但这个JavaScript文件相当混乱，并不是一般所见的js文件；在尝试使用412错误所返回的三个cookie去请求也不行，因此另寻它法，使用了某讯的"),i("a",h,[e("api"),n(d)]),e("，国外疫情"),i("a",b,[e("api"),n(d)]),e("。")]),p])}const q=a(o,[["render",_],["__file","telegram-bot-Paimon-note-1.html.vue"]]);export{q as default};
